...
class ProductJdbcRepositoryTest {
    ...
    private final Product newProduct = new Product(UUID.randomUUID(), "new-product", Category.COFFEE_BEAN_PACKAGE, 1000, "sample" , LocalDateTime.now(), LocalDateTime.now());
    ...
    void testFindByName() {
        var product = repository.findByName(newProduct.getName());
